  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-2xl md:text-5xl mb-4 text-white max-w-4xl font-black font-display tracking-tight">
          Development Journey
        </h2>
        <p className="text-neutral-400 text-sm md:text-lg max-w-xl leading-relaxed">
          From my first console log to architecting enterprise MERN solutions. Here is how I built my career as a full-stack specialist.
        </p>
      </div>
