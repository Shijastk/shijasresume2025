...
export const AIAgent: React.FC = () => {
  ...
  const [messages, setMessages] = useState<{ role: 'user' | 'assistant'; text: string }[]>([
    { role: 'assistant', text: "Hi! I'm Shijas's AI Assistant. Ask me anything about his work or experience." }
  ]);
  ...
  return (
    <div className="fixed bottom-8 right-8 z-[60]">
      ...
      <button
        ...
        className={`w-14 h-14 rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 ${isOpen ? 'bg-rose-500 rotate-90' : 'bg-indigo-600'
          }`}
      >
